...
/** @type {string} */
const CACHE_VERSION = '1762161820|7274152197';
/** @type {string} */
const CACHE_PREFIX = 'ЗєфаляторКозла-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Зєфалятор Казла.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Зєфалятор Казла.html","Зєфалятор Казла.js","Зєфалятор Казла.offline.html","Зєфалятор Казла.icon.png","Зєфалятор Казла.apple-touch-icon.png","Зєфалятор Казла.audio.worklet.js","Зєфалятор Казла.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Зєфалятор Казла.wasm","Зєфалятор Казла.pck","Зєфалятор Казла.side.wasm"];
